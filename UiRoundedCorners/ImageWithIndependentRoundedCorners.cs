...
namespace Nobi.UiRoundedCorners {
	...
	public class ImageWithRoundedCorners : MonoBehaviour {
		...
		private void OnEnable() {
            ...
            if (other != null)
            {
                radius = other.r.x;					//On component swap, get the radius value from it first, and apply it to this component.
		...
		public void Refresh() {
			...
			material.SetVector(Props, new Vector4(rect.width, rect.height, radius * 2, 0));		//FFaUniHan: To make the radius value appear consistent with ImageWithIndependentRoundedCorners script.
		}
	}
}
